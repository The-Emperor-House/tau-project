  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center md:justify-start gap-1 mt-3 flex-wrap">
        <SocialIcon href="https://line.me/ti/p/@tauruswerenew" label="Line Official TAURUS">
          <FaLine />
        </SocialIcon>
        <span className="mx-1 text-white/90 text-sm text-center md:text-left">
          ติดตามผลงานเพิ่มเติมของเราได้ที่
        </span>
        <SocialIcon href="https://www.facebook.com/taurusrenovation" label="Facebook">
          <CgFacebook />
        </SocialIcon>
        <SocialIcon href="https://www.instagram.com/taurus.renovation" label="Instagram">
          <FaInstagram />
        </SocialIcon>
        <SocialIcon href="https://www.tiktok.com/@taurus.renovation" label="TikTok">
          <SiTiktok />
        </SocialIcon>
